...
console.log('search rei: '+ hashTable.search('rei'));
console.log('search lita: '+ hashTable.search('lita'));
console.log('search serena: '+ hashTable.search('serena'));

console.log('remove darien: '+ hashTable.remove('darien'));
console.log('remove mina: '+ hashTable.remove('mina'));
